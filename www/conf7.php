...
<form method="post">
<h2>HDRLOG</h2> ACTIVO
<input title="ENTRE si O no EN minuscula" type="text" name="activahdr" size="50" value="'.htmlspecialchars( $activahdr ).'" />
<br> USUARIO
<input title="USUARIO DE HDRLOG" type="text" name="hdruser" size="50" value="'.htmlspecialchars( $hdruser ).'" />
<br> CODIGO
<input title="SU CODIGO (NO PASSWORD)" type="password" name="hdrcode" size="50" value="'.htmlspecialchars( $hdrcode ).'" />
<br>
<br>
