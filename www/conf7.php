...
$hactivahdr = htmlspecialchars( $activahdr );
$hhdruser = htmlspecialchars( $hdruser );
$hhdrcode = htmlspecialchars( $hdrcode );
echo '
    <head>
        ...
        <form method="post">
            <h2>HDRLOG</h2> ACTIVO
            <input title="ENTRE si O no EN minuscula" type="text" name="activahdr" size="50" value="'.$hactivahdr.'" />
            <br> USUARIO
            <input title="USUARIO DE HDRLOG" type="text" name="hdruser" size="50" value="'.$hhdruser.'" />
            <br> CODIGO
            <input title="SU CODIGO (NO PASSWORD)" type="password" name="hdrcode" size="50" value="'.$hhdrcode.'" />
            <br>
            <br>
