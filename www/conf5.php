...
<form method="post">
<h2>APRS</h2> ACTIVO
<input title="ENTRE si O no EN minuscula" type="text" name="activaaprs" size="50" value="'.htmlspecialchars( $activaaprs ).'" />
<br> CORDENADAS
<input title="EJ 3428.20S/05845.35W" type="text" name="aprsqth" size="50" value="'.htmlspecialchars( $aprsqth ).'" />
<br> PASSCODE
<input title="EL PASSCODE DE APRS" type="password" name="aprscode" size="50" value="'.htmlspecialchars( $aprscode ).'" />
<br>
<br>
