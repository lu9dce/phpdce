...
<?php include 'C:\\phpdce\\usr\\variables.php'; ?>
    ...
    <body>
        ...
        <form method="post">
            ...
            <input title="ENTRE si O no EN minuscula" type="text" name="activacluster" size="50" value="<?php echo htmlspecialchars($activacluster); ?>" />
            <br> IP
            <input title="DIRECCION O IP DEL CLUSTER QUE USA (TELNET)" type="text" name="clustertelnet" size="50" value="<?php echo htmlspecialchars($clustertelnet); ?>" />
            <br> PUERTO
            <input title="PUERTO TELNET" type="text" name="clusterport" size="50" value="<?php echo htmlspecialchars($clusterport); ?>" />
            <br>
            <br>
