...
$hactivacluster = htmlspecialchars( $activacluster );
$hclustertelnet = htmlspecialchars( $clustertelnet );
$hclusterport = htmlspecialchars( $clusterport );
echo '
    <head>
        ...
        <form method="post">
            ...
            <input title="ENTRE si O no EN minuscula" type="text" name="activacluster" size="50" value="'.$hactivacluster.'" />
            <br> IP
            <input title="DIRECCION O IP DEL CLUSTER QUE USA (TELNET)" type="text" name="clustertelnet" size="50" value="'.$hclustertelnet.'" />
            <br> PUERTO
            <input title="PUERTO TELNET" type="text" name="clusterport" size="50" value="'.$hclusterport.'" />
            <br>
            <br>
