...
<?php include 'C:\\phpdce\\usr\\variables.php'; ?>
    ...
    <body>
        ...
        <form method="post">
            ...
            <input title="ENTRE si O no EN minuscula" type="text" name="sendmail" size="50" value="<?php echo htmlspecialchars($sendmail); ?>" />
            <br> FONDO QSL
            <input title="RUTA COMPLETA O URL CON JPG&#10;(escribe azar para fondos ramdon)" type="text" name="fondo" size="50" value="<?php echo htmlspecialchars($fondo); ?>" />
            <br> SMTP
            <input title="DATOS DE SU SMTP (ATENCION SE RECOMIENDA QUE USE GMX.COM)" type="text" name="usemail" size="50" value="<?php echo htmlspecialchars($usemail); ?>" />
            <br> USUARIO
            <input title="USUARIO?" type="text" name="useuser" size="50" value="<?php echo htmlspecialchars($useuser); ?>" />
            <br> PASSWORD
            <input title="PASSWORD?" type="password" name="usepass" size="50" value="<?php echo htmlspecialchars($usepass); ?>" />
            <br> COMENTARIO
            <input title="PARA LA QSL" type="text" name="dxcomen" size="50" value="<?php echo htmlspecialchars($dxcomen); ?>" />
            <br>
            <br>
