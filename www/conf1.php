...
<input title="SU LICENCIA EN MAYUSCULA" type="text" name="milicencia" size="50" value="'.htmlspecialchars( $milicencia ).'" />
<br> EMAIL
<input title="MAIL USADO PARA LA IMAGEN QSL" type="text" name="miemail" size="50" value="'.htmlspecialchars( $miemail ).'" />
<br> NOMBRE
<input title="SU NOMBRE Y APELLIDO" type="text" name="minombre" size="50" value="'.htmlspecialchars( $minombre ).'" />
<br> QTH
<input title="SU QTH (EJ BUENOS AIRES - ARGENTINA)" type="text" name="miqth" size="50" value="'.htmlspecialchars( $miqth ).'" />
<br> LOCATOR
<input title="LOCADOR" type="text" name="migrid" size="50" value="'.htmlspecialchars( $migrid ).'" />
<br> COMENTARIO
<input title="COMENTARIO PARA COMPLETAR EL QSO" type="text" name="dxcomen" size="50" value="'.htmlspecialchars( $dxcomen ).'" />
<br>
<br>
