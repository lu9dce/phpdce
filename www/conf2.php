...
echo '<h2>ADI LOCATION</h2>';
echo 'ADI <input title="VERY IMPORTANT! (Ex C:\Users\eduardo\AppData\Local\WSJT-X\wsjtx_log.adi)" type="text" name="adiwsjt" size="50" value="'.htmlspecialchars( $adiwsjt ).'" /><br>';
echo '<p>Normally WSJT and JTDX are in %localappdata%</p><br>';
