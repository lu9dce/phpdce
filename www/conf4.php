...
echo '<h2>EQSL</h2>';
echo 'ACTIVO <input title="ENTRE si O no EN minuscula" type="text" name="activaeqsl" size="50" value="'.htmlspecialchars( $activaeqsl ).'" /><br>';
echo 'USUARIO <input title="SU USUARIO DE EQSL" type="text" name="eqsluser" size="50" value="'.htmlspecialchars( $eqsluser ).'" /><br>';
